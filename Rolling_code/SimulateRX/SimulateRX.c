...
#define CMD1 0x20// RED toggle command
#define CMD2 0x22// BlUE toggle command
#define CMD3 0x24// GREEN toggle command

#define LED1	0 // Led1 connected to port C pin 0
#define LED2	1 // Led2 connected to port C pin 1
#define LED3	2 // Led3 connected to port C pin 2
